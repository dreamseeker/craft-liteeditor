 ...
 *
 * Lite Editor FieldType for Craft CMS
 *
 * --snip--
...
class LiteEditorPlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('Lite Editor FieldType for Craft CMS');
    }
    ...
    {
        return 'https://github.com/dreamseeker/liteeditor/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/dreamseeker/liteeditor/master/releases.json';
    }
